  ...
  return (
    <div className="flex flex-col  w-full h-full items-center justify-center  bg-[#fafafa]  px-20 pb-20 ">
       ...
       <div className="grid xl:grid-cols-2 w-full gap-x-40 gap-y-20 font-clash">
        ...
        <a href="" download className='flex items-center justify-center bg-[#69C6AC] hover:bg-[#69C6AC]/80 text-white font-medium border border-black p-2 rounded-xl'>
            CV english
        </a>
        <a href="" download className='flex items-center justify-center bg-[#696fc6] text-white font-medium border border-black p-2 rounded-xl'>
            CV español
        </a>
      </div>
