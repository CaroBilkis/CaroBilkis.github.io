...
export default function Dropdown() {
  ...
  return (
    ...
    <div className={'font-epilogue lg:h-screen p-8 bg-[#FAFAFA] relative h-full snap-start snap-always  '}>
        ...
        <div className={'flex flex-row gap-12 '}>
            ...
            <button onClick={()=>controlFeatures()}  className='flex flex-row gap-3 items-center text-sm font-medium  text-[#6A6A6A] hover:text-black relative' >
            <span>Features</span> 
              {features ?
             <>
             <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 5 4-4 4 4"/></svg>
              
              <div className='absolute top-10 right-0 w-40 h-40 bg-white flex flex-col p-8 justify-center gap-3 rounded-lg shadow-lg'>
              <a href='' className='flex flex-row gap-2 self-'>
                ...
                <h5 className='text-sm font-medium  text-[#6A6A6A]'>Todo list</h5>
                </a> 
            ...
            <a href=''  className='flex flex-row gap-2'>
                ...
                <h5 className='text-sm font-medium  text-[#6A6A6A]'>Calendar</h5>
                </a> 
                ...
                <h5 className='text-sm font-medium  text-[#6A6A6A]'>Reminders</h5>
                </a> 
                ...
                <h5 className='text-sm font-medium  text-[#0E0E0E]'>Planning</h5>
                </a>
            ...
            <button onClick={()=>controlCompany()}  className='flex flex-row gap-3 items-center text-sm font-medium  text-[#6A6A6A] hover:text-black relative'>Company
            {company ?
            <>
            <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 5 4-4 4 4"/></svg>
                <div className='absolute top-10 left-0 p-8 h-40 w-40 flex flex-col items-start gap-3 bg-white shadow-xl rounded-lg'> 
                <h5 className='text-sm font-medium  text-[#6A6A6A] hover:text-black'>History</h5>
                <h5 className='text-sm  font-medium  text-[#6A6A6A] hover:text-black'>Our Team</h5>
                <h5 className='text-sm font-medium  text-[#6A6A6A] hover:text-black'>Blog</h5>
                </div>
            </>
             :
            <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" stroke-width="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>}
            </button>
            <button className='text-sm font-medium   text-[#6A6A6A] hover:text-black' >Careers</button>
            <button className='text-sm font-medium  text-[#6A6A6A] hover:text-black'>About</button>
            </div>
        </div>

            <div className='md:flex flex-row gap-8 sm:hidden hidden'>
            <button className='text-sm font-medium  text-[#0E0E0E] hover:text-black'> Login</button>
            <button className='text-sm font-medium  text-[#0E0E0E] py-2 px-4 rounded-lg border-2 hover:text-black hover:border-black'> Register</button>
           </div>

           <div className={menu ? 'hidden' :'flex sm:flex md:hidden'} onClick={()=>controlMenu()}>
           <svg  class="w-8 text-[#0E0E0E] hover:text-gray-600" fill="currentColor" stroke="none" viewBox="0 0 32 18">
           ...
           <svg  class="w-8 text-[#0E0E0E] hover:text-gray-600" fill="currentColor" stroke="none" viewBox="0 0 32 32">
       ...
       {menu ? 
        <div>
        <div className=' absolute top-0 right-0 sm:flex flex md:hidden  z-40 bg-[#fafafa] h-full w-56'>
            <div className='flex flex-col gap-2  items-start  p-4 mt-32'>
            <button onClick={()=>controlFeaturesL()} className='flex flex-row gap-3 items-center text-sm font-medium  text-[#0E0E0E] hover:text-black' >Features 
           ...
           <svg width="14" height="16" xmlns="http://www.w3.org/2000/svg"><path d="M14 3v12a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h1V1a1 1 0 1 1 2 0v1h2V1a1 1 0 1 1 2 0v1h2V1a1 1 0 0 1 2 0v1h1a1 1 0 0 1 1 1Zm-2 3H2v1h10V6Zm0 3H2v1h10V9Zm0 3H2v1h10v-1Z" fill="#726CEE"/></svg>            
           <h5 className='text-sm font-medium  text-[#0E0E0E]'>Todo list</h5>
            </div> 

           <div className='flex flex-row gap-2'>
            <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg"><path d="M12.667 8.667h-4v4h4v-4ZM11.334 0v1.333H4.667V0h-2v1.333h-1C.75 1.333 0 2.083 0 3v11.333C0 15.25.75 16 1.667 16h12.667C15.25 16 16 15.25 16 14.333V3c0-.917-.75-1.667-1.666-1.667h-1V0h-2Zm3 14.333H1.667V5.5h12.667v8.833Z" fill="#4BB1DA"/></svg>
            <h5 className='text-sm font-medium  text-[#0E0E0E]'>Calendar</h5>
            </div> 

            <div className='flex flex-row gap-2'>
            <svg width="13" height="17" xmlns="http://www.w3.org/2000/svg"><path d="M6.408 13.916c-3.313 0-6-1.343-6-3 0-.612.371-1.18 1-1.654V7.916a5 5 0 0 1 3.041-4.6 2 2 0 0 1 3.507-1.664 2 2 0 0 1 .411 1.664 5.002 5.002 0 0 1 3.041 4.6v1.346c.629.474 1 1.042 1 1.654 0 1.657-2.687 3-6 3Zm0 1c.694 0 1.352-.066 1.984-.16.004.054.016.105.016.16a2 2 0 0 1-4 0c0-.055.012-.106.016-.16.633.094 1.29.16 1.984.16Z" fill="#EDD556"/></svg>            
            <h5 className='text-sm font-medium  text-[#0E0E0E]'>Reminders</h5>
            </div> 
            ...
            <button onClick={()=>controlCompanyL()} className='flex flex-row gap-3 items-center text-sm font-medium  text-[#0E0E0E] hover:text-black'>Company
            ...
            {companyL ? 
           <div className='p-2 px-4 flex flex-col gap-3'> 
           <h5 className='text-sm font-medium  text-[#0E0E0E] hover:text-black'>History</h5>
           <h5 className='text-sm font-medium  text-[#0E0E0E] hover:text-black'>Our Team</h5>
           <h5 className='text-sm font-medium  text-[#0E0E0E] hover:text-black'>Blog</h5>
            </div>
            :''}

            <button className='text-sm font-medium   text-[#0E0E0E] hover:text-black' >Careers</button>
            <button className='text-sm font-medium  text-[#0E0E0E] hover:text-black'>About</button>
            </div>
           
        </div> 
        <div className='w-full h-screen p-8 top-0 left-0 bg-black opacity-70 absolute flex sm:flex md:hidden '>
       ...
       ""}
        ...
        <div className={menu ? '  flex md:flex-row sm:flex-col-reverse flex-col-reverse md:w-full  justify-between  gap-8  mx-auto md:mt-24 sm:mt-8 mt-8' :
        ' flex md:flex-row sm:flex-col-reverse flex-col-reverse w-full  justify-between  gap-8  mx-auto md:mt-24 sm:mt-8 mt-8'}>
        <div className=' flex flex-col w-full lg:w-1/2   md:justify-between sm:gap-14 gap-14  '>
           ...
           <h1 className=' font-extrabold text-4xl flex sm:flex md:hidden sm:mx-auto mx-auto'>Make  remote work</h1>
            ...
            <button className='bg-[#0E0E0E] rounded-lg text-[#fafafa] p-3 w-36 sm:mx-auto mx-auto md:mx-0 hover:text-black border-2 hover:border-black hover: hover:bg-[#fafafa]'>Learn more</button>
            </div>
            <div className='flex flex-row items-center justify-center  gap-8 '>
          
            <svg class="w-full h-full aspect-[4/3]  text-[#ADADAD] hover:text-[#0E0E0E]" fill="currentColor" stroke="none" viewBox="0 0 110 20">
             ...
             <svg class="w-full h-full aspect-[4/3] text-[#ADADAD] hover:text-[#0E0E0E]" fill="currentColor" stroke="none" viewBox="0 0 110 40">
            ...
            <svg class="w-full h-full aspect-[4/3] text-[#ADADAD]n hover:text-[#0E0E0E]" fill="currentColor" stroke="none" viewBox="0 0 110 40">
        ...
        <div className=' w-full lg:w-1/3  h-full self-center'>
            <img className='w-full h-full object-contain aspect-[3/4] md:flex sm:hidden hidden' src="../img/dropdown/image-hero-desktop.png" alt="Hero" />
            <img className='w-full h-full object-contain aspect-[3/4]  md:hidden sm:flex flex ' src="../img/dropdown/image-hero-mobile.png" alt="Hero" />
        </div>
        </div>
    </div>
